...
// ============================================================
const C = {
  // Normal vuruş — sakin ama dinamik spiker anlatımı
  normal: [
    ...
    "{a} kılıcını savurdu, {b} {dmg} hasarla tanıştı.",
    "Ustaca bir manevra! {a}, {b}'ye {dmg} hasar işledi.",
    "{a} tereddüt etmedi: {b}'ye {dmg} hasar.",
    "Zarif ama acımasız — {a}'dan {b}'ye {dmg} hasar.",
    "{b} kalkanını kaldırdı ama {a} {dmg} hasarı buldu.",
    "{a} nabız yokluyor, {b} {dmg} hasar aldı.",
    "Temiz bir vuruş! {a} → {b}, {dmg} hasar defterde.",
    "{a} adım attı, savurdu, {b} {dmg} hasarla sendeledi.",
    "{b}'nin refleksi yetmedi — {a} {dmg} hasar geçirdi.",
    "{a} sabırla bekledi ve {b}'ye {dmg} hasar yerleştirdi.",
    "Bir çentik daha! {a}, {b}'nin canından {dmg} götürdü.",
    "{a} tempoyu elinde tutuyor: {b}'ye {dmg} hasar.",
    "{b} nefeslendi derken {a} {dmg} hasarla araya girdi.",
    "Kısa ve öz — {a}'dan {b}'ye {dmg} hasar.",
    "{a} hedefini şaşırmadı, {b} {dmg} hasar yedi.",
    "Çelik çeliğe değdi, kazançlı çıkan {a}: {dmg} hasar.",
    "{a} bir açı buldu, {b}'ye {dmg} hasarı yedirdi.",
    "{b} savunmada kaldı, {a} {dmg} hasarla ödüllendi.",
    "{a} işini biliyor: {b}'ye {dmg} hasar, temiz iş.",
    "Ölçülü bir darbe — {b} {dmg} hasarla geri çekildi.",
    "{a} baskıyı sürdürüyor, {b} {dmg} hasar daha aldı.",
    "Tok bir vuruş! {a} → {b}, {dmg} hasar.",
    "{a} rakibini okuyor, {b}'ye {dmg} hasar.",
    "{b} açığı kapatamadı, {a} {dmg} hasarla sızdı.",
    "{a}'nın kılıcı konuştu: {b}'ye {dmg} hasar.",
    "Disiplinli bir hamle, {b} {dmg} hasarla sarsıldı.",
    "{a} yükleniyor — {b}'nin üzerine {dmg} hasar.",
    "{b} dengesini bozdu, {a} {dmg} hasarla cezalandırdı.",
    "Net bir isabet! {a}, {b}'ye {dmg} hasar yazdırdı.",
    "{a} hiç acele etmeden {b}'ye {dmg} hasar verdi.",
  ],
  // Kritik vuruş — coşkulu, patlayıcı spiker anlatımı
  crit: [
    ...
    "💥 İNANILMAZ! {a} mükemmel zamanladı, {dmg} kritik hasar!",
    "💥 {b} bunu görmedi bile — {a}'dan {dmg} kritik!",
    "💥 Yer yerinden oynadı! {a} {dmg} kritik hasar patlattı!",
    "💥 KRİTİK VURUŞ! {a} tribünleri ayağa kaldırdı: {dmg} hasar!",
    "💥 {a} kükredi ve {b}'ye {dmg} kritik hasar indirdi!",
    "💥 Nefes kesici! {b} {dmg} kritik hasarla yıkıldı!",
    "💥 {a}'nın kılıcı şimşek gibi çaktı — {dmg} kritik!",
    "💥 Tam kalbinden! {a}, {b}'ye {dmg} kritik hasar!",
    "💥 KRİTİK! Arena inledi, {b} {dmg} hasar yedi!",
    "💥 {a} gücünü konuşturdu: {dmg} devasa kritik hasar!",
    "💥 Bu ne vuruş böyle! {a} → {b}, {dmg} kritik!",
    "💥 {b} yerinde kalakaldı — {a}'dan {dmg} kritik hasar!",
    "💥 Kusursuz! {a} zayıf anı yakaladı, {dmg} kritik!",
    "💥 KRİTİK! {a} sahneyi çaldı, {b} {dmg} hasarla düştü resmen!",
    "💥 Gökten inen darbe! {b} {dmg} kritik hasar aldı!",
    "💥 {a} rakibini paramparça etti: {dmg} kritik hasar!",
    "💥 Muhteşem! {a}, {b}'nin canından {dmg} kopardı!",
    "💥 KRİTİK! {b} sersemledi, {a} {dmg} hasarla ezdi geçti!",
    "💥 {a} tam not aldı bu hamleden: {dmg} kritik hasar!",
    "💥 Sahanın efendisi {a}! {b}'ye {dmg} kritik!",
    "💥 Yıldırım hızında! {a}, {b}'ye {dmg} kritik hasar!",
    "💥 {b} bu darbeyle kabusu yaşadı — {dmg} kritik!",
    "💥 KRİTİK! {a} adeta dans ederek {dmg} hasar patlattı!",
    "💥 Duvar gibi savunma çöktü — {a}'dan {dmg} kritik!",
    "💥 {a} tarih yazıyor: {b}'ye {dmg} kritik hasar!",
    "💥 Bomba gibi! {b} {dmg} kritik hasarla sarsıldı!",
    "💥 {a} rakibine nefes aldırmadı: {dmg} kritik hasar!",
    "💥 KRİTİK VURUŞ! {a}, {b}'yi {dmg} ile diz çöktürdü!",
    "💥 İşte bu! {a}'nın kılıcı {b}'ye {dmg} kritik yazdı!",
    "💥 {b} savrulup gitti — {a}'dan {dmg} kritik hasar!",
  ],
  // Hızdan gelen ekstra (peş peşe ikinci) vuruş — çevik, hızlı anlatım
  extra: [
    ...
    "⚡ Göz açıp kapayana kadar! {a}'dan {dmg} hasar daha.",
    "⚡ {a} fırtına gibi esti: ek {dmg} hasar!",
    "⚡ Bir değil iki! {a}, {b}'ye {dmg} hasar daha.",
    "⚡ Refleksler zirvede! {a} {dmg} hasarı hemen tekrarladı.",
    "⚡ {b} daha ne olduğunu anlamadan {dmg} hasar daha!",
    "⚡ Hız kesmiyor! {a}'dan art arda {dmg} hasar.",
    "⚡ Çift darbe! {a}, {b}'ye {dmg} hasar daha yazdı.",
    "⚡ {a} adeta ışınlandı — ek {dmg} hasar!",
    "⚡ Kombine hamle! {a}'dan {b}'ye {dmg} hasar daha.",
    "⚡ Nefes almadan! {a} {dmg} hasarı üst üste bindirdi.",
    "⚡ {a}'nın çevikliği konuştu: {dmg} ek hasar!",
    "⚡ Rüzgar gibi! {b} {dmg} hasar daha yedi.",
    "⚡ Zincirleme! {a}, {b}'ye {dmg} hasarla devam etti.",
    "⚡ {a} boşluk tanımıyor — {dmg} hasar daha!",
  ],
  // Öldürücü darbe — zafer coşkusu
  finish: [
    ...
    "🏆 BİTTİ! {a}, {b}'yi {dmg} hasarla tarihe gömdü!",
    "🏆 Son perde! {a}'nın {dmg} hasarı {b}'yi bitirdi!",
    "🏆 {b} yığıldı! {a} {dmg} hasarla zaferi kaptı!",
    "🏆 İşte şampiyon! {a}, {b}'ye son {dmg} hasarı yapıştırdı!",
    "🏆 Muhteşem final! {a} {dmg} hasarla düelloyu kapattı!",
    "🏆 {a} son sözü söyledi: {dmg} hasar, {b} yerde!",
    "🏆 Zil çaldı, kazanan {a}! Öldürücü {dmg} hasar!",
    "🏆 {b} savaşı bıraktı — {a}'nın {dmg} hasarı yetti de arttı!",
    "🏆 Destansı bir bitiriş! {a}, {b}'yi {dmg} ile alt etti!",
    "🏆 Perde kapandı! {a} {dmg} hasarla galibiyeti mühürledi!",
    "🏆 {a} zaferini ilan etti: son {dmg} hasar {b}'ye!",
    "🏆 Nefesler tutuldu, {a} {dmg} hasarla kazandı!",
    "🏆 {b} teslim oldu — {a}'dan öldürücü {dmg} hasar!",
    "🏆 Ve düello {a}'nın! {dmg} hasarlık son darbe!",
  ],
  // Düello başlangıcı
  intro: [
    ...
    "⚔️ Arena sessizleşti... ve {a} atağa kalktı!",
    "⚔️ Kılıçlar çekildi! {a} öne çıkıyor.",
    "⚔️ Gong vuruldu — {a} ilk kanı arıyor!",
    "⚔️ İki savaşçı, tek zafer. {a} başlıyor!",
    "⚔️ Toz bulutu kalktı, {a} hücuma geçti!",
    "⚔️ Nefesler tutuldu. {a}, {b}'nin üzerine yürüyor!",
  ],
  // Zamanlama sınırı (tur limiti dolunca)
  timeout: [
    "⏳ Süre doldu! Canı fazla olan {a} galip ilan edildi.",
    "⏳ Turlar bitti — {a} daha ayakta, zafer onun!",
    "⏳ Uzun bir mücadele! Kalan cana göre {a} kazandı.",
    "⏳ Çetin geçti ama {a} son düdükte önde bitirdi!",
    "⏳ Kıl payı! Canı fazla olan {a} düelloyu aldı.",
    "⏳ Maraton bitti — {a} ayakta kalmayı başardı!",
  ],
};
