...
export const NEW_FEATURE_SLIDES = {
  "2.3": [
    { icon: "🏚", title: "YIKIK KALE AÇILDI", text: "Diyar haritasındaki üçüncü kapının kilidi kırıldı. Seviye 35'i geçen her savaşçı artık Yıkık Kale'ye adım atabilir — ve bu sefer hoşgörü yok: 35, kesin sınır. Kum rengi taş avlular, kuzeyde yarısı göçmüş bir sur hattı, gölgesi hâlâ heybetli bir kale... Orman öğretti, bataklık sınadı — kale ise hesap soruyor. Kapıdan girerken kılıcını değil, karakterini kuşan." },
    { icon: "🏰", title: "ELLE KURULMUŞ BİR HARABE", text: "Bu diyar rastgele serpilmiş taşlardan ibaret değil; her köşesi bir hikâye anlatıyor. Kuzeyde yıkık kalenin iki yanında dimdik ayakta kalmış kuleler, surun koptuğu köşelerde devrilmiş burçlar. Güneybatıda çatısı çökmüş evleriyle terk edilmiş bir köy. Ve güneydoğuda, kum taşının ortasında bir vaha: çimenle çevrili, kayaları suyun içinde uyuyan küçük bir göl. Zemindeki her dikdörtgen taş, her çatlak, her yosun lekesi tek tek işlendi. Savaşmaya geldin ama etrafına bakmadan çıkma." },
    { icon: "👹", title: "KALENİN ÜÇ MUHAFIZI", text: "Surların yeni sahipleri var ve üçü de kendi kafasına göre dövüşüyor. Bronz zırhlı SAVAŞÇI iki farklı kılıç darbesiyle üstüne yürür; köşeye sıkıştırma, öfkelenir. MOR PİYON asla tek gezmez — yoldaşını bulur, sürüsü yanındayken cesaretlenir ve üstüne çok daha çabuk şarj eder. Ama asıl yenilik OKÇU: bu oyunun ilk menzilli düşmanı. Mesafesini korur, yayını gerdiğinde nişan çizgisi üstüne kilitlenir ve oku gerçekten uçar. Yaklaşırsan kaçar, beklerken yan adımlarla süzülür. Ona koşarak değil, düşünerek yaklaş." },
    { icon: "🛡️", title: "TEK VURUŞ DEVRİ KAPANDI", text: "Bataklık canavarlarını artık tek kılıçta biçtiğini biliyoruz — kale bunun cezası. Buradaki muhafızların canı bataklıktakilerin DÖRT KATI: Savaşçı yüzlerce can taşıyor, Piyon ondan da dayanıklı, Okçu uzaktan uzaktan seni eritirken kolay kolay devrilmiyor. Vuruşları da ağırlaştı ama ölçülü — seni tek hamlede ezmezler, yavaş yavaş tüketirler. Bu diyar bir kesim bahçesi değil; her kelle, hakkıyla alınacak." },
    { icon: "💰", title: "KALENİN HAZİNESİ AĞZINA KADAR", text: "Zorluğun karşılığı katbekat ödeniyor. Kestiğin HER muhafız 6-10 Altın bırakır, her kelle 10-17 EXP getirir — bataklığın iki katından fazla. Nadir kitaplar burada çok daha sık düşüyor, nadir eşyalar neredeyse her uzun avda çantana giriyor. Ve iki yeni zirve: EFSANEVİ KİTAP ve EFSANEVİ EŞYA artık haritadan düşebiliyor — ikisi de gerçek, ikisi de oyuna döndüğünde hesabına ve envanterine birebir işleniyor. Kale, sadık olana cömerttir." },
    { icon: "💬", title: "MUHAFIZLAR KONUŞUYOR", text: "Bu diyarın sakinleri sessiz sedasız ölmüyor. Kalenin muhafızları ara ara lafa giriyor: kimisi efendisinin adına yemin ediyor, kimisi dertleşiyor, kimisi seninle dalgasını geçiyor. Ne dediklerini buraya yazmayacağız — kimin neyi neden söylediğini anlamak da avın bir parçası. Tek diyeceğimiz şu: vurmadan önce bir saniye dinle. Pişman olmazsın." },
    { icon: "🧙", title: "KAHRAMANIN YENİ ZIRHI", text: "Sadece dünya değil, sen de değiştin. Kahramanın baştan aşağı yeni kuşamıyla sahada: bronz Maximus miğferi, omuzlarda deri kayışlı zırh, kolda plaka eldivenler ve elinde kavisli bir pala. Yürüyüşünden kılıç savuruşuna her animasyon bu yeni görünüşle yeniden işlendi. Aynaya bak — yani göle — kendini tanıyamayabilirsin." },
    { icon: "🔥", title: "ÜÇ DİYAR SENİN, İKİSİ SIRADA", text: "Fadeless'ın haritasında beş kapı var ve üçü artık ardına kadar açık. Orman, bataklık, kale... Sırada Gölge Uçurumu bekliyor. Her güncellemede bu dünyayı sizin için biraz daha büyütüyor, biraz daha derinleştiriyoruz — geri bildiriminiz her taşında var. Sizin için çalışıyoruz, ve durmuyoruz. Şimdi git: kale düştü, ama muhafızları hâlâ teslim olmadı." }
  ],
  "2.2": [
...
// ============================================================
export const LATEST_UPDATE_VERSION = "2.3";
