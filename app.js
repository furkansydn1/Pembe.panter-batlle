...
const myAttackWarEl = document.getElementById("myAttackWar");
const myDefenseWarEl = document.getElementById("myDefenseWar");
const myPointsWarEl = document.getElementById("myPointsWar");
const myDustWarEl = document.getElementById("myDustWar");
const myAttackEnvEl = document.getElementById("myAttackEnv");
const myDefenseEnvEl = document.getElementById("myDefenseEnv");
const myPointsEnvEl = document.getElementById("myPointsEnv");
const myDustEnvEl = document.getElementById("myDustEnv");
...
function renderMyStats() {
  ...
  if (myAttackWarEl) myAttackWarEl.textContent = currentPlayerData.attack ?? BASE_ATTACK;
  if (myDefenseWarEl) myDefenseWarEl.textContent = currentPlayerData.defense ?? BASE_DEFENSE;
  if (myPointsWarEl) myPointsWarEl.textContent = currentPlayerData.points ?? 0;
  if (myDustWarEl) myDustWarEl.textContent = currentPlayerData.dust ?? 0;
  if (myAttackEnvEl) myAttackEnvEl.textContent = currentPlayerData.attack ?? BASE_ATTACK;
  if (myDefenseEnvEl) myDefenseEnvEl.textContent = currentPlayerData.defense ?? BASE_DEFENSE;
  if (myPointsEnvEl) myPointsEnvEl.textContent = currentPlayerData.points ?? 0;
  if (myDustEnvEl) myDustEnvEl.textContent = currentPlayerData.dust ?? 0;
